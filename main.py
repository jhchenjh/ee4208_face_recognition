...
if __name__ == '__main__':
    ...
    while(video_capture.isOpened()):
        ...
        for x, y, w, h in faces:
            ...
            if name_id in range(80, 85):
                id = 'Jinghuan'
            elif name_id in range(85, 90):
                id = 'Jinhai'
            elif name_id in range(90, 95):
                id = 'Wenhan'
            elif name_id in range(95, 100):
                id = 'Yongyao'
            else:
                id = 'others'

            cv2.putText(img, str(name_id)+':'+id, (x+5,y-5), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255) , 2)
            cv2.putText(img, str(score[0]), (x + 5, y+h - 5), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 1)
